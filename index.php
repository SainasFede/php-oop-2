...
$products = [
    ...
    new Clean(new Category('Cat', '<i class="fa-solid fa-shield-cat"></i>'), 'TripocanClean', 'TropiClean', 13, 'https://arcaplanet.vtexassets.com/arquivos/ids/273387/TROPICLEAN-WATERLESS-CAT-SHAMPOO-ML.220.jpg?v=1756084205', 0.120 ,'Shampoo'),
  ...
  <main class="w-100">
    <div class="container">
      <div class="row my-5 d-flex justify-content-center align-items-center">
        ...
        <div class="card text-center p-2 m-4" style="width: 16rem;">
          <h4 class="card-title"><?php echo $product->category->target ?><span class="mx-3"><?php echo $product->category->icon ?></span></h4>
          <img src="<?php echo $product->getImg()?>" class="card-img-top" alt="<?php echo $product->name ?>">
        <div class="card-body text-start">
          ...
          <h6> Dimensioni: <?php echo $product->size?></h6>
          <?php endif; ?>
          <h6>Peso: <?php echo $product->weight?> Kg</h6>
        </div>
        </div>
        <?php endforeach;?>
      </div>
